...
const (
	...
	CONTROLLER_USER_EMAIL_EXIST_ERROR         = "该邮箱已被注册使用!"
...
// interface
const (
	CONTROLLER_INTERFACE_ERROR_CODE_HEADER  = "1001"
	CONTROLLER_INTERFACE_ERROR_MSG_HEADER   = "对不起，您无权限访问"
	CONTROLLER_INTERFACE_ERROR_CODE_PROGRAM = "1002"
	CONTROLLER_INTERFACE_ERROR_MSG_PROGRAM  = "对不起，接口程序发生异常，请稍后再试"
	CONTROLLER_INTERFACE_ERROR_CODE_DATA    = "1003"
	CONTROLLER_INTERFACE_ERROR_MSG_DATA     = "对不起，数据格式错误"
)
